...
if (phrase!==undefined){
       ...
       // msg = phrase;
        //console.log(1+answer+2+phrase+3+match+4+wholeMatch);
        
        //ScribeSpeak(msg, function() {callback(); });
        console.log('okkkkkkkkk');ontest(phrase,x)//;callback({'tts' : " "});
      }
      //else if (phrase!==x) {//console.log(1+answer+2+phrase+3+match+4+wholeMatch);
        //ScribeSpeak("Je ne suis pas sûr que tu aies répondu à ma question !", function () {//console.log(phrase1);
      //    console.log(phrase)
        //  console.log(x)
          //ask(x)
        //});
